        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="-mr-2 flex md:hidden">
            <button
              ...
              type="button"
              className="bg-gray-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
      ...
      >
        {(ref) => (
          <div className="md:hidden" id="mobile-menu">
            <div className="px-2 pt-3 pb-5 space-y-1 flex flex-col gap-3 sm:px-3">
              <div>
